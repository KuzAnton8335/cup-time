			...
			<div className="container footer__container">
				...
				<div className="footer__nav">
					<ul className="footer__menu">
						<li className="footer__item">
							<a href="#" className="footer__link">Чай</a>
						</li>
						<li className="footer__item">
							<a href="#" className="footer__link">Кофе</a>
						</li>
						<li className="footer__item">
							<a href="#" className="footer__link">Чайники</a>
						</li>
						<li className="footer__item">
							<a href="#" className="footer__link">Турки</a>
						</li>
						<li className="footer__item">
							<a href="#" className="footer__link">Прочее</a>
						</li>
					</ul>
				</div>
				<div className="footer__info">
					...
					<ul className="footer__developers">
						...
						<li className="footer__developer">
							Developer: <a href="#" className="footer__developer-link">Kuznecov Anton</a>
						</li>
					</ul>
				</div>
				<div className="footer__contacts">
					<a href="mailto:CUPTIME@gmail.com" className="footer__mail-link">CUPTIME@gmail.com</a>
